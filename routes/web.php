...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/stock/get-low-stock-report', [LowStockController::class, 'lowStock'])->name('report.low.stock');
    Route::get('/stock/get-low-stock-report/datatable', [LowStockController::class, 'datatableList'])->name('report.low.stock.ajax');
