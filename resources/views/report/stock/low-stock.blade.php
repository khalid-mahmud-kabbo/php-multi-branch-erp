@extends('layouts.app')
@section('title', __('item.stock_report'))
            ...
            <div class="col-12 col-lg-12">
                <div class="card">
                    <div class="card-header px-4 py-3 d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="mb-0 text-uppercase">{{ __('item.stock_report') }}</h5>
                        </div>
                    </div>
                    <div class="card-body">
...
<script src="{{ versionedAsset('custom/js/reports/low-stock-list.js') }}"></script>
@endsection
