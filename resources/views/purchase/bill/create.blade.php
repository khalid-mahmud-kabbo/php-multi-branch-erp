...
<div class="page-wrapper">
    ...
    <td class="w-50">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="apply_discount_checkbox">
            <label class="form-check-label fw-bold cursor-pointer" for="apply_discount_checkbox">{{ __('apply_discount') }}</label>
        </div>
    </td>
    <td class="w-50">
        <div class="input-group">
            <x-input type="text" additionalClasses="text-end cu_numeric discount_total" name="total_discount" placeholder="Discount" value="0" />

            <!-- Dropdown for Discount Type -->
            <select name="total_discount_type" class="form-select" id="discount_type" onchange="calculateInvoiceTotals()">
